 ...
 * @author Amos Shi
 */
public class DefaultFileComponent extends FileComponent implements
		GenerateTreeNode {
	 ...
	 * 
	 * @param start
	 *            Start Position of the File component
	 * @param len
	 *            Length of the File component
	 */
	...
	public void generateTreeNode(DefaultMutableTreeNode parentNode) {
		parentNode.add(new DefaultMutableTreeNode(new JTreeNodeFileComponent(
				super.startPos, super.length, this.treeNodeText)));
	}
}
