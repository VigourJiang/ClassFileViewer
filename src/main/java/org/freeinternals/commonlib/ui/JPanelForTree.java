...
public class JPanelForTree extends JPanel {
	...
	private void layoutComponents() {
		...
		glue.setMaximumSize(new Dimension(Short.MAX_VALUE, this.toolbar
				.getHeight()));
		panel_Toolbar.add(glue);

		final JPanel panel_toolbar_tree = new JPanel();
		panel_toolbar_tree.setLayout(new BoxLayout(panel_toolbar_tree,
				BoxLayout.Y_AXIS));
		...
		splitPane
				.setBottomComponent(new JScrollPane(this.editorPaneDescription));
	...
	private void toolbar_ShowDetails() {
		JFrameTool.showPopup(this.topLevelFrame, this.details_panel,
				this.details_title);
	}
