...
public class AttributeInnerClasses extends AttributeInfo {
	...
	AttributeInnerClasses(final u2 nameIndex, final String type,
	...
	public final class Class extends ClassComponent {
		...
		private Class(final PosDataInputStream posDataInputStream)
			...
			this.inner_class_info_index.value = posDataInputStream
					.readUnsignedShort();
			this.outer_class_info_index = new u2();
			this.outer_class_info_index.value = posDataInputStream
					.readUnsignedShort();
			this.inner_name_index = new u2();
			this.inner_name_index.value = posDataInputStream
					.readUnsignedShort();
			this.inner_class_access_flags = new u2();
			this.inner_class_access_flags.value = posDataInputStream
					.readUnsignedShort();
		}
