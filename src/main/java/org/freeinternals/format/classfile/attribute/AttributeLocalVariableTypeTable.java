 ...
 */
public class AttributeLocalVariableTypeTable extends AttributeLocalVariableTable_base {
	AttributeLocalVariableTypeTable(final u2 nameIndex, final String type,
