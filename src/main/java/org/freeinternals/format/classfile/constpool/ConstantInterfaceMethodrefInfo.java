 ...
 *      VM Spec: The CONSTANT_InterfaceMethodref_info Structure </a>
 */
public class ConstantInterfaceMethodrefInfo extends AbstractCPInfo {
	...
	public String getDescription() {
		return String
				.format("ConstantIntegerInfo: Start Position: [%d], length: [%d], value: class_index=[%d], name_and_type_index=[%d].",
						this.startPos, this.length, this.class_index.value,
