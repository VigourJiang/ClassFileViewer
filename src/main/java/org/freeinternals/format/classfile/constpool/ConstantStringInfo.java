 ...
 *      VM Spec: The CONSTANT_String_info Structure </a>
 */
public class ConstantStringInfo extends AbstractCPInfo {
	...
	public String getDescription() {
		return String
				.format("ConstantStringInfo: Start Position: [%d], length: [%d], value: string_index=[%d].",
						this.startPos, this.length, this.string_index.value);
	}
