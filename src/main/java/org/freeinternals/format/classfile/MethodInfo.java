 ...
 * @since JDK 6.0
 * @see <a
 *      href="http://www.freeinternals.org/mirror/java.sun.com/vmspec.2nded/ClassFile.doc.html#1513">
 *      VM Spec: Methods </a>
 */
public class MethodInfo extends ClassComponent {
	...
	MethodInfo(final PosDataInputStream posDataInputStream,
	...
	public List<AttributeInfo> getArrtibutes(){
	 ...
	 * 
	 * @param index
	 *            Index of the method attribute(s)
